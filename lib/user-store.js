...
function createFreshUser(id, name) {
    return {
        ...
        medcomSession: null,        // { noticeId, cards, usedIdx, activeIdx, ... } — активна QTE-сесія
        lastMedcomCards: [],        // щоб та сама скарга двічі поспіль давала коротше вікно реакції
        medcomStats: { passed: 0, failed: 0 },
        medcomCard: 0,               // Медична картка (0-10, постійна) — 10/10 = 7 днів щита, потім знову з нуля

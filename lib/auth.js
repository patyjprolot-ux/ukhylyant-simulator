...
// ==========================================
// botToken не міняється за час життя процесу, тож перерахунок HMAC-ключа на
// КОЖЕН виклик verifyInitData (а це майже кожен API-запит гри) — зайва
// робота (аудит оптимізації 2026-08-21). Кешуємо по токену: той самий підхід
// лишається безпечним, якщо колись знадобиться кілька токенів одночасно.

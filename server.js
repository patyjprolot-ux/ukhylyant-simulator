...
<head>
    ...
    <style>
        ...
        .symptom-card.hit-flash { border-color: #39ff14; background: rgba(57,255,20,0.14); }
        .symptom-card.miss-flash { border-color: #ff4d4d; background: rgba(255,77,77,0.14); }
        ...
        function renderNotices() {
            ...
            list.innerHTML = notices.map(n => {
                ...
                return '<div class="notice-card' + (urgent ? ' urgent' : '') + '" data-uid="' + n.uid + '">' +
                    ...
                    // Медкомісія (2026-08-16, переглянуто): НЕ реакція на повістку — розробник
                    // прямо заборонив ігри/тапи на повістці ("серйозна річ, не гра в молодець").
                    // Медкомісія стає окремою сюжетною вкладкою (вилазка в лікарню, довідки,
                    // хвороби) — див. PATCH_2.0_MEDICAL_QUESTLINE.md. Кнопку тут прибрано.
